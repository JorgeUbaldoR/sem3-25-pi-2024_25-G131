package pt.ipp.isep.dei.esoft.project.domain.sprint1;
...
public class FileDataReader {
    ...
    private static final String MACHINE_PATH = "prodPlanSimulator(ESINF)/main/java/pt/ipp/isep/dei/esoft/project/files/input/workstations.csv";
